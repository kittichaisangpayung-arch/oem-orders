...
**สำหรับคุณ**: Folder ID = `1nHxNzRASn0i-WjpZ7DAvXMruNSfumNo7`
...
ระบบจะสร้างโครงสร้างแบบนี้โดยอัตโนมัติ:
...
**ตัวอย่าง Path**: 
- `po_pdfs/2569/กันยายน/สัปดาห์ที่ 2/1/PO_001.pdf`
- สัปดาห์คำนวณจากวันที่ของเดือน (วันที่ 1-7 = สัปดาห์ที่ 1, วันที่ 8-14 = สัปดาห์ที่ 2, ฯลฯ)
