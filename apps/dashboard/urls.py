...
urlpatterns = [
    ...
    path("stores/set-claim/", views.set_claim, name="set_claim"),
    path("stores/set-compensation/", views.set_compensation, name="set_compensation"),
    ...
    path("invoices/create-from-dns/", views.create_invoice_from_selected_dns, name="create_invoice_from_selected_dns"),
