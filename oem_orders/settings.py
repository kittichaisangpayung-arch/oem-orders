"""
Django settings for oem_orders project.
...
SECRET_KEY = 'django-insecure-2m8ar&-)@!mcw!fj^re%=q6o)-nexe9xho+@6krhs8&gfbqx$f'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'False') == 'True'

ALLOWED_HOSTS = ['.vercel.app', '.now.sh', '.onrender.com', '.pythonanywhere.com', 'localhost', '127.0.0.1']
...
WSGI_APPLICATION = 'oem_orders.wsgi.application'
